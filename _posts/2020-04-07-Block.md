...
![memory layout](../../../assets/images/block1.png)
...
![Block3](../../../assets/images/block3.png)

不难看出，`block`在截获普通变量的时候，只是将值传递到了`block`中，因此，不能修改外部参数。

而加上修饰符后：

![Block4](../../../assets/images/block4.png)
